...
{
    "distutils": {
        "name": "cython_client360",
        "sources": [
            "cython_client360.pyx"
        ]
    },
    "module_name": "cython_client360"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_client360
#define __PYX_HAVE_API__cython_client360
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'cython_client360' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static __Pyx_memviewslice __pyx_v_16cython_client360_img_view = { 0, 0, { 0 }, { 0 }, { 0 } };
static int __pyx_v_16cython_client360_num_pixels;
...
#define __Pyx_MODULE_NAME "cython_client360"
extern int __pyx_module_is_main_cython_client360;
int __pyx_module_is_main_cython_client360 = 0;

/* Implementation of 'cython_client360' */
...
static const char __pyx_k_xy_cnt[] = "xy_cnt";
...
static const char __pyx_k_bytes_out[] = "bytes_out";
...
static const char __pyx_k_pixelBytes[] = "pixelBytes";
...
static const char __pyx_k_cython_client360[] = "cython_client360";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_cython_client360_pyx[] = "cython_client360.pyx";
...
static PyObject *__pyx_n_s_bytes_out;
...
static PyObject *__pyx_n_s_cython_client360;
static PyObject *__pyx_kp_s_cython_client360_pyx;
...
static PyObject *__pyx_n_s_pixelBytes;
...
static PyObject *__pyx_n_s_xy_cnt;
static PyObject *__pyx_n_s_y;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_16cython_client360_proc(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pixelBytes); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_16cython_client360_1proc(PyObject *__pyx_self, PyObject *__pyx_v_pixelBytes); /*proto*/
static PyMethodDef __pyx_mdef_16cython_client360_1proc = {"proc", (PyCFunction)__pyx_pw_16cython_client360_1proc, METH_O, 0};
static PyObject *__pyx_pw_16cython_client360_1proc(PyObject *__pyx_self, PyObject *__pyx_v_pixelBytes) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("proc (wrapper)", 0);
  __pyx_r = __pyx_pf_16cython_client360_proc(__pyx_self, ((PyObject *)__pyx_v_pixelBytes));
...
static PyObject *__pyx_pf_16cython_client360_proc(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_pixelBytes) {
 ...
 */
  ...
  __pyx_v_bytes_out = __pyx_kp_b_;

  /* "cython_client360.pyx":13
 *     #t1 = dt.now().microsecond
 *     bytes_out = b''
 *     cdef int i = 0             # <<<<<<<<<<<<<<
 *     cdef int x = 0
 ...
 */
  __pyx_v_num_bytes = 0x7E900;

  /* "cython_client360.pyx":20
 *     #for i in range(int(num_pixels)):
 *     #    bytes_out+=input_bytes
 ...
 *     xy_cnt = 0
 */
  __Pyx_INCREF(__pyx_v_pixelBytes);
  __Pyx_DECREF_SET(__pyx_v_bytes_out, __pyx_v_pixelBytes);

  /* "cython_client360.pyx":21
 *     #    bytes_out+=input_bytes
 *     bytes_out=pixelBytes
 *     i=0             # <<<<<<<<<<<<<<
 *     xy_cnt = 0
 ...
 */
  while (1) {
    __pyx_t_1 = ((__pyx_v_i < __pyx_v_num_bytes) != 0);
    if (!__pyx_t_1) break;

    /* "cython_client360.pyx":27
 *     global img
 *     while i<num_bytes:
 *         x = int(xy_cnt/480)             # <<<<<<<<<<<<<<
 *         y = int(xy_cnt%480)
 ...
 */
    __pyx_v_x = ((int)__Pyx_div_long(__pyx_v_xy_cnt, 0x1E0));

    /* "cython_client360.pyx":28
 *     while i<num_bytes:
 *         x = int(xy_cnt/480)
 *         y = int(xy_cnt%480)             # <<<<<<<<<<<<<<
 *         #print(bytes_out[i],bytes_out[i+1],bytes_out[i+2])
 * 
 */
    __pyx_v_y = ((int)__Pyx_mod_long(__pyx_v_xy_cnt, 0x1E0));

    /* "cython_client360.pyx":31
 *         #print(bytes_out[i],bytes_out[i+1],bytes_out[i+2])
 * 
 ...
 */
    __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_bytes_out, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
    ...
    if (unlikely(!__pyx_v_16cython_client360_img_view.memview)) { __Pyx_RaiseUnboundLocalError("img_view"); __PYX_ERR(0, 31, __pyx_L1_error) }
    __pyx_t_4 = __pyx_v_x;
    __pyx_t_5 = __pyx_v_y;
    __pyx_t_6 = 0;
    __pyx_t_7 = -1;
    if (__pyx_t_4 < 0) {
      __pyx_t_4 += __pyx_v_16cython_client360_img_view.shape[0];
      if (unlikely(__pyx_t_4 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_4 >= __pyx_v_16cython_client360_img_view.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_16cython_client360_img_view.shape[1];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_16cython_client360_img_view.shape[1])) __pyx_t_7 = 1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_16cython_client360_img_view.shape[2];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 2;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_16cython_client360_img_view.shape[2])) __pyx_t_7 = 2;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 31, __pyx_L1_error)
    }
    *((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_16cython_client360_img_view.data + __pyx_t_4 * __pyx_v_16cython_client360_img_view.strides[0]) ) + __pyx_t_5 * __pyx_v_16cython_client360_img_view.strides[1]) ) + __pyx_t_6 * __pyx_v_16cython_client360_img_view.strides[2]) )) = __pyx_t_3;

    /* "cython_client360.pyx":32
 * 
 *         img_view[x,y,0] = bytes_out[i]
 *         img_view[x,y,1] = bytes_out[i+1]             # <<<<<<<<<<<<<<
 *         img_view[x,y,2] = bytes_out[i+2]
 ...
 */
    ...
    __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_bytes_out, __pyx_t_8, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (unlikely(!__pyx_v_16cython_client360_img_view.memview)) { __Pyx_RaiseUnboundLocalError("img_view"); __PYX_ERR(0, 32, __pyx_L1_error) }
    __pyx_t_9 = __pyx_v_x;
    __pyx_t_10 = __pyx_v_y;
    __pyx_t_11 = 1;
    __pyx_t_7 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_16cython_client360_img_view.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_16cython_client360_img_view.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_16cython_client360_img_view.shape[1];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_16cython_client360_img_view.shape[1])) __pyx_t_7 = 1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_16cython_client360_img_view.shape[2];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_7 = 2;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_16cython_client360_img_view.shape[2])) __pyx_t_7 = 2;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 32, __pyx_L1_error)
    }
    *((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_16cython_client360_img_view.data + __pyx_t_9 * __pyx_v_16cython_client360_img_view.strides[0]) ) + __pyx_t_10 * __pyx_v_16cython_client360_img_view.strides[1]) ) + __pyx_t_11 * __pyx_v_16cython_client360_img_view.strides[2]) )) = __pyx_t_3;

    /* "cython_client360.pyx":33
 *         img_view[x,y,0] = bytes_out[i]
 *         img_view[x,y,1] = bytes_out[i+1]
 *         img_view[x,y,2] = bytes_out[i+2]             # <<<<<<<<<<<<<<
 *         i+=3
 ...
 */
    ...
    __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_bytes_out, __pyx_t_8, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (unlikely(!__pyx_v_16cython_client360_img_view.memview)) { __Pyx_RaiseUnboundLocalError("img_view"); __PYX_ERR(0, 33, __pyx_L1_error) }
    __pyx_t_12 = __pyx_v_x;
    __pyx_t_13 = __pyx_v_y;
    __pyx_t_14 = 2;
    __pyx_t_7 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_16cython_client360_img_view.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_16cython_client360_img_view.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_16cython_client360_img_view.shape[1];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_16cython_client360_img_view.shape[1])) __pyx_t_7 = 1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_16cython_client360_img_view.shape[2];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_7 = 2;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_16cython_client360_img_view.shape[2])) __pyx_t_7 = 2;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 33, __pyx_L1_error)
    }
    *((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_16cython_client360_img_view.data + __pyx_t_12 * __pyx_v_16cython_client360_img_view.strides[0]) ) + __pyx_t_13 * __pyx_v_16cython_client360_img_view.strides[1]) ) + __pyx_t_14 * __pyx_v_16cython_client360_img_view.strides[2]) )) = __pyx_t_3;

    /* "cython_client360.pyx":34
 *         img_view[x,y,1] = bytes_out[i+1]
 *         img_view[x,y,2] = bytes_out[i+2]
 *         i+=3             # <<<<<<<<<<<<<<
 *         xy_cnt+=1
 ...
 */
    __pyx_v_xy_cnt = (__pyx_v_xy_cnt + 1);
  }

  /* "cython_client360.pyx":37
 *         xy_cnt+=1
 * 
 *     img = np.asarray(img_view,dtype = np.uint8)             # <<<<<<<<<<<<<<
 *     #print(img)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_asarray); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_15);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (unlikely(!__pyx_v_16cython_client360_img_view.memview)) { __Pyx_RaiseUnboundLocalError("img_view"); __PYX_ERR(0, 37, __pyx_L1_error) }
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_16cython_client360_img_view, 3, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_16 = PyTuple_New(1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 37, __pyx_L1_error)
  ...
  __pyx_t_18 = __Pyx_PyObject_GetAttrStr(__pyx_t_17, __pyx_n_s_uint8); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_18) < 0) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_t_18 = __Pyx_PyObject_Call(__pyx_t_15, __pyx_t_16, __pyx_t_2); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
  __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_img, __pyx_t_18) < 0) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;

  /* "cython_client360.pyx":39
 *     img = np.asarray(img_view,dtype = np.uint8)
 *     #print(img)
 *     return img             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_18, __pyx_n_s_img); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __pyx_r = __pyx_t_18;
  __pyx_t_18 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cython_client360.proc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cython_client360.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_client360.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_client360._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cython_client360(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_client360},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bytes_out, __pyx_k_bytes_out, sizeof(__pyx_k_bytes_out), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_cython_client360, __pyx_k_cython_client360, sizeof(__pyx_k_cython_client360), 0, 0, 1, 1},
  {&__pyx_kp_s_cython_client360_pyx, __pyx_k_cython_client360_pyx, sizeof(__pyx_k_cython_client360_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_pixelBytes, __pyx_k_pixelBytes, sizeof(__pyx_k_pixelBytes), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_xy_cnt, __pyx_k_xy_cnt, sizeof(__pyx_k_xy_cnt), 0, 0, 1, 1},
 ...
 * #print(img)
 */
  __pyx_tuple__20 = PyTuple_Pack(3, __pyx_int_360, __pyx_int_480, __pyx_int_3); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_tuple__20); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 *     bytes_out = b''
 */
  __pyx_tuple__22 = PyTuple_Pack(7, __pyx_n_s_pixelBytes, __pyx_n_s_bytes_out, __pyx_n_s_i, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_xy_cnt, __pyx_n_s_num_bytes); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(1, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_client360_pyx, __pyx_n_s_proc, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 10, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_client360(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_client360(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_client360(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_client360(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_client360(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_client360' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_client360(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_client360", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_client360) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_client360")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_client360", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_intc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_DTYPE); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__21, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_img, __pyx_t_3) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "cython_client360.pyx":6
 * DTYPE = np.intc
 * img = np.zeros((360,480,3),dtype = DTYPE)
 * cdef int[:,:,:] img_view = img             # <<<<<<<<<<<<<<
 * #print(img)
 * cdef int num_pixels = 172800
 */
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_img); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __PYX_XDEC_MEMVIEW(&__pyx_v_16cython_client360_img_view, 1);
  __pyx_v_16cython_client360_img_view = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "cython_client360.pyx":8
 * cdef int[:,:,:] img_view = img
 * #print(img)
 * cdef int num_pixels = 172800             # <<<<<<<<<<<<<<
 * 
 * def proc(pixelBytes):
 */
  __pyx_v_16cython_client360_num_pixels = 0x2A300;
 ...
 *     bytes_out = b''
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_16cython_client360_1proc, NULL, __pyx_n_s_cython_client360); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_proc, __pyx_t_3) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_client360", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_client360");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
